...
public class FreeLikeApi {
    ...
    public LikeResponse checkLikeStatus(
        ...
        FreeLikeService.FreeLikeResult result = freeLikeService.isLikedByMember(freeBoardId, memberId);
    ...
    public LikeResponse putLike(
        ...
        FreeLikeService.FreeLikeResult result = freeLikeService.toggleLike(freeBoardId, memberId);
