...
public interface FreeLikeMapper {
    ...
    int countByMemberIdAndBoardId(@Param("memberId") Long memberId, @Param("freeBoardId") Long freeBoardId);

    int countByBoardId(Long freeBoardId);

    void deleteByMemberIdAndBoardId(@Param("memberId") Long memberId, @Param("freeBoardId") Long freeBoardId);
}
